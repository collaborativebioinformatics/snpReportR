...
#VCF Data must be saved with .vcf or .vcf.gz
...
outfiles <- list()
sample_list <- unlist(strsplit("DRR131561_dx.variants.HC_hard_cutoffs,DRR131564_dx.variants.HC_hard_cutoffs,DRR131565_dx.variants.HC_hard_cutoffs,DRR131587_dx.variants.HC_hard_cutoffs,DRR131593_dx.variants.HC_hard_cutoffs",split = ","))
